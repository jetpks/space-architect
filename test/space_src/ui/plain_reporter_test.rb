...
class PlainReporterTest < Minitest::Test
  PlainReporter = Space::Src::UI::PlainReporter
  ...
  def test_org_listed_success_emits_name_and_count
    r = make_reporter
    org_ref = Space::Src::Config::OrgRef.new(host: "github.com", name: "socketry")
  ...
  def test_org_listed_failure_emits_failed_marker
    r = make_reporter
    org_ref = Space::Src::Config::OrgRef.new(host: "github.com", name: "badorg")
