...
class InteractiveReporterTest < Minitest::Test
  IR = Space::Src::UI::InteractiveReporter
  ...
  def test_g1_no_thread_new_in_source
    path = File.expand_path("../../../lib/space_src/ui/interactive_reporter.rb", __dir__)
  ...
  def test_gs6_listing_phase_emits_per_org_persistent_lines
    reporter, out = make_reporter(cadence: 0.01)
    orgs = [
      Space::Src::Config::OrgRef.new(host: "github.com", name: "org-a"),
      Space::Src::Config::OrgRef.new(host: "github.com", name: "org-b")
    ]
  ...
  def test_gs6_listing_phase_failure_org_emits_failed_line
    reporter, out = make_reporter(cadence: 0.01)
    org = Space::Src::Config::OrgRef.new(host: "github.com", name: "bad-org")
  ...
  def test_gs6_render_fiber_alive_across_both_phases
    reporter, = make_reporter(cadence: 0.01)
    org = Space::Src::Config::OrgRef.new(host: "github.com", name: "myorg")
  ...
  def test_gs6_listing_output_bounded_by_org_count_not_repo_count
    ...
    n_orgs = 3
    orgs = n_orgs.times.map { |i| Space::Src::Config::OrgRef.new(host: "github.com", name: "org#{i}") }
  ...
  def test_ga1_ga2_last_org_line_precedes_sweep_lines
    reporter, out = make_reporter(cadence: 0.01)
    orgs = [
      Space::Src::Config::OrgRef.new(host: "github.com", name: "first-org"),
      Space::Src::Config::OrgRef.new(host: "github.com", name: "last-org")
    ]
