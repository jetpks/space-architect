...
class CLIStatusTest < Minitest::Test
  ...
  def test_status_renders_per_repo_evergreen_table
    with_cli_env do |env, _home|
      ...
      seeded = Space::Src::State::Store::State.new(
        repos: {
          "github.com/ruby/ruby" => Space::Src::State::Store::Repo.new(
          ...
          "github.com/other/repo" => Space::Src::State::Store::Repo.new(
            default_branch: "main",
      ...
      Space::Src::State::Store.write(paths.state_file, seeded)
  ...
  def test_status_subprocess_prints_table
    with_cli_env do |env, _home|
      ...
      seeded = Space::Src::State::Store::State.new(
        repos: {
          "github.com/x/y" => Space::Src::State::Store::Repo.new(
            default_branch: "trunk",
            last_fetch_at: "2026-06-12T20:01:33Z",
            last_synced_at: "2026-06-12T20:01:34Z",
            status: "clean",
  ...
  def seed_status_state(paths)
    Space::Src::State::Store.write(paths.state_file,
      Space::Src::State::Store::State.new(
        repos: {
          "github.com/ruby/ruby" => Space::Src::State::Store::Repo.new(
            default_branch: "trunk",
            last_fetch_at: "2026-06-12T20:01:33Z",
