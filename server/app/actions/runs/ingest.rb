...
module Space
  module Server
    module Actions
      module Runs
        class Ingest < Space::Server::Action
          include Space::Server::Deps["repos.runs_repo", "repos.conversations_repo", "repos.messages_repo", "redis"]
          ...
          def handle(req, res)
            ...
            result = Space::Server::Runs::Ingest.new(redis, persistor: persistor).call(run, req.env["rack.input"])
