    ...
    module Actions
      module Shares
        class Create < Space::Server::Action
          include Space::Server::Deps["repos.conversations_repo", "repos.conversation_shares_repo"]
          ...
          def handle(req, res)
            ...
            account = Space::Server::Github.lookup(login)
          ...
          rescue Space::Server::Github::NotFound
            redirect_back_with_flash(req, res,
              fallback: "/conversations/#{conversation_id}",
              alert: "No GitHub user or organization named #{login}.")
          rescue Space::Server::Github::Error
            redirect_back_with_flash(req, res,
              fallback: "/conversations/#{conversation_id}",
