    ...
    module Config
      class Show < Dry::CLI::Command
        ...
        def call(**opts)
          ...
          handle_errors do
            rows = SpaceCadet::Config::EDITABLE_KEYS.map do |key|
...
SpaceCadet::CLI::Registry.register "config" do |prefix|
  prefix.register "show", SpaceCadet::CLI::Config::Show
  prefix.register "path", SpaceCadet::CLI::Config::ConfigPath
  prefix.register "set",  SpaceCadet::CLI::Config::Set
end
