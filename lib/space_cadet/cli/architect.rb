...
SpaceCadet::CLI::Registry.register "architect" do |prefix|
  ...
  prefix.register "worktree" do |wt|
    wt.register "add",    SpaceCadet::CLI::Architect::Worktree::Add
    wt.register "remove", SpaceCadet::CLI::Architect::Worktree::Remove
    wt.register "list",   SpaceCadet::CLI::Architect::Worktree::List
  end
end
