...
class CLIOrgTest < Minitest::Test
    ...
    with_cli_env do |env, _home|
      ...
      SpaceArchitect::Pristine::Config::Store.write(paths.config_file,
        SpaceArchitect::Pristine::Config::Store.load(paths.config_file).success.new(
          orgs: [
            SpaceArchitect::Pristine::Config::OrgRef.new(host: "github.com", name: "socketry"),
            SpaceArchitect::Pristine::Config::OrgRef.new(host: "github.com", name: "example-org", include_archived: true)
          ]
        ))
  ...
  def test_org_list_shows_ignored_repos_when_non_empty
    with_cli_env do |env, _home|
      ...
      SpaceArchitect::Pristine::Config::Store.write(paths.config_file,
        SpaceArchitect::Pristine::Config::Store.load(paths.config_file).success.new(
          orgs: [
            SpaceArchitect::Pristine::Config::OrgRef.new(host: "github.com", name: "bigco",
              ignored_repos: ["monorepo", "huge"])
          ]
        ))
      out, _err = invoke_command(PristineCLI::Org::List)
  ...
  def test_org_list_omits_ignored_repos_when_empty
    with_cli_env do |env, _home|
      ...
      SpaceArchitect::Pristine::Config::Store.write(paths.config_file,
        SpaceArchitect::Pristine::Config::Store.load(paths.config_file).success.new(
          orgs: [SpaceArchitect::Pristine::Config::OrgRef.new(host: "github.com", name: "plain")]
        ))
      out, _err = invoke_command(PristineCLI::Org::List)
